    ...
    return (
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary" style={{ width: "1200px" }}>
          <div class="container-fluid">
            ...
            <Link to="/adminusers" className="btn btn-success">All Users</Link>
            <Link to="/adminhome" className="btn btn-success">All Product</Link>
            <Link to="/adminorders" className="btn btn-success">All Order</Link>
            <Link to="/adminreviews" className="btn btn-success">All Reviews</Link>
            <Link to="/adminofferdisplay" className="btn btn-success">All Offer</Link>
            <Link to="/displaycategories" className="btn btn-success">All categories</Link>
          </div>
        </nav>
      </div>
